...
public class PolicyDeploymentImplTest extends PFTestWithDataSource {
    ...
    public void oneTimeSetupTestApplication() throws DictionaryException, IOException {
        ...
        InputStream decodedInputStream = Base64.getMimeDecoder().wrap(new ByteArrayInputStream(SMALL_EXE_UUE.getBytes()));
        Files.copy(decodedInputStream, Paths.get(SMALL_EXE));
