...
/**
 * @author hchan
 * @version $Id: //depot/Destiny/D_Nimbus/release/8.1.2/main/src/server/pf/src/java/test/com/bluejungle/pf/tools/TestLocationImporterCLI.java#1 $
 */
public class TestLocationImporterCLI {
	private MockLocationImporterCLI cli;
	
	@Before
	public void cleanUp() throws InvalidOptionDescriptorException {
		OptionMod.reset();
	...
	private class MockLocationImporterCLI extends LocationImporterCLI {
		 ...
		 */
		public MockLocationImporterCLI() throws InvalidOptionDescriptorException {
			super();
		}
