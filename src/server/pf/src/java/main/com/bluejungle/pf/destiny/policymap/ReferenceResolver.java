...
public class ReferenceResolver {
    ...
    private final Collection<DeploymentEntity> deployedEntities;
    ...
    public ReferenceResolver(Collection<DeploymentEntity> deployedEntities) {
    ...
    private void resolve(final String partialNameMatch, final Pattern partialNameMatchPattern) throws PQLException {
        ...
        for (final DeploymentEntity entity : deployedEntities) {
            if (entity.getType().isPqlEntity()) {
