...
/**
 * @author sasha
 * @version $Id: //depot/Destiny/D_Nimbus/release/8.1.2/main/src/server/pf/src/java/main/com/bluejungle/pf/destiny/lib/axis/PolicyDeploymentImpl.java#1 $:
 */
...
public class PolicyDeploymentImpl implements IPolicyDeployment, IManagerEnabled, IInitializable, ILogEnabled {
    ...
    ,   IVersion agentVersion
        ...
        SystemUser[] systemUsers = request.getDeploymentRequestChoice_type0() != null ?
                                   request.getDeploymentRequestChoice_type0().getPolicyUsers() : null;
