...
/**
 * @author sgoldstein
 * @version $Id: //depot/Destiny/D_Nimbus/release/8.1.2/main/src/server/security/src/java/test/com/bluejungle/destiny/server/security/ServerSecurityTestSuite.java#1 $
 */
