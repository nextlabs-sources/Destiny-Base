 ...
 * @author sergey
 *
 * @version $Id: //depot/Destiny/D_Nimbus/release/8.1.2/main/src/server/dictionary/src/java/main/com/bluejungle/dictionary/ElementBaseAttribute.java#1 $
 */
...
abstract class ElementBaseAttribute implements IMappedElementField {
     ...
     */
    public static final ElementBaseAttribute INTERNAL_KEY = new ElementBaseAttribute("originalId", "Internal Key") {
