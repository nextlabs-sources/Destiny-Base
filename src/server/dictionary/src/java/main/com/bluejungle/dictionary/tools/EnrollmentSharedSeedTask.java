 ...
 * 
 * @author hchan
 * @version $Id: //depot/Destiny/D_Nimbus/release/8.1.2/main/src/server/dictionary/src/java/main/com/bluejungle/dictionary/tools/EnrollmentSharedSeedTask.java#1 $
 */
