 ...
 * @author sergey
 *
 * @version $Id: //depot/Destiny/D_Nimbus/release/8.1.2/main/src/server/dictionary/src/java/test/com/bluejungle/dictionary/TestEnrollmentSetup.java#1 $
 */
...
public class TestEnrollmentSetup extends TestCase {
    ...
    public void testEnrollmentStatus() throws DictionaryException {
        ...
        // Verify getUpdateRecord() method returns null ( not record )
        ...
        // Verify getUpdateRecord() method returns same msg
        record = enrollment.getUpdateRecord();
