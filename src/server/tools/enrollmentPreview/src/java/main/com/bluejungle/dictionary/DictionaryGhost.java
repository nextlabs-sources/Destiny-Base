 ...
 * 
 * @author hchan
 * @version $Id: //depot/Destiny/D_Nimbus/release/8.1.2/main/src/server/tools/enrollmentPreview/src/java/main/com/bluejungle/dictionary/DictionaryGhost.java#1 $
 */
