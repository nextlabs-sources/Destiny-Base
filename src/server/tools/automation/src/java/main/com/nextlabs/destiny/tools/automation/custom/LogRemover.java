...
/**
 * @author rlin
 * @version $Id: //depot/Destiny/D_Nimbus/release/8.1.2/main/src/server/tools/automation/src/java/main/com/nextlabs/destiny/tools/automation/custom/LogRemover.java#1 $
 */
