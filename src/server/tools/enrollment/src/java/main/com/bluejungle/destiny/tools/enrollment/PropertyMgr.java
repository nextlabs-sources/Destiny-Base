...
public class PropertyMgr extends EnrollmentMgrShared {
    ...
    private void addColumn(String type, String logicalName, String displayName, String entityType)
            throws EnrollmentMgrException{
        AttributeType attributeType = AttributeType.Factory.fromValue(type.toUpperCase());
        EntityType eType = EntityType.Factory.fromValue(entityType.toUpperCase());
        ...
        columnToAdd.setType(attributeType);
        columnToAdd.setLogicalName(logicalName);
        columnToAdd.setDisplayName(displayName);
        columnToAdd.setParentType(eType);
    ...
    private void delColumn(String logicalName, String elementType) throws EnrollmentMgrException {
        enrollmentWS.delColumn(logicalName, EntityType.Factory.fromValue(elementType));
    }
