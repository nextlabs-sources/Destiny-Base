...
public class EnrollmentMgrOptionDescriptorEnum extends EnrollmentMgrSharedOptionDescriptorEnum {
    ...
    protected static final OptionId<Boolean> DELTA_OPTIONS_ID            = OptionId.create("delta",    OptionValueType.ON_OFF);
    ...
    protected static final OptionId<Boolean> NO_PROMPT_ID                = OptionId.create("noprompt", OptionValueType.ON_OFF); 
    ...
    protected EnrollmentMgrOptionDescriptorEnum() throws InvalidOptionDescriptorException {
        ...
        description = "noprompt";
        option = Option.createOnOffOption(NO_PROMPT_ID, description);
        root.add(option);
        ...
        //enroll -sync -delta is optional used to sync data with delta changes to control center
        description = "Incremental Changes for LDIF Enrollment Sync";
        Option<Boolean> deltaNameOption = Option.createOnOffOption(DELTA_OPTIONS_ID, description);
        root.add(deltaNameOption);
    ...
    public String getLongDescription() {
        ...
        return "-------------------------------------------------------------------------" + N 
            ...
            + "    Ldif Delta Sync: "+N
            + "    enrollmgr -u username -sync -delta  -n DomainName "+N
            + "\n"
