...
public abstract class EnrollmentMgrSharedOptionDescriptorEnum implements IConsoleApplicationDescriptor{
    ...
    static final OptionId<String> ENCRYPTED_KEYSTORE_PASSWORD_OPTION_ID = OptionId.create("ez", OptionValueType.STRING);
    ...
    protected void addSharedOptions(CompoundOptionDescriptorBase root){
        ...
        description = "password, if no password is given on the command line you will be prompted for it";
        valueLabel = "password";
        option = Option.createOption(PASSWORD_OPTION_ID, description, valueLabel, null);
        root.add(option);
        
        description = "encrypted password, if no password is given on the command line you will be prompted for it";
        valueLabel = "encryptedpassword";
        option = Option.createOption(ENCRYPTED_PASSWORD_OPTION_ID, description, valueLabel, null);
        root.add(option);
        ...
        description = "encrypted keystore password";
        valueLabel = "encryptedKeystorePassword";
        option = Option.createOption(ENCRYPTED_KEYSTORE_PASSWORD_OPTION_ID, description, valueLabel, null);
        root.add(option);
