...
/**
 * @author hchan
 * @version $Id: //depot/Destiny/D_Nimbus/release/8.1.2/main/src/server/tools/enrollment/src/java/test/com/bluejungle/destiny/tools/enrollment/util/TestValidationHelper.java#1 $
 */
