...
/**
 * @author hchan
 * @version $Id: //depot/Destiny/D_Nimbus/release/8.1.2/main/src/server/tools/dbinit/src/java/test/com/bluejungle/destiny/tools/dbinit/DBInitTestBase.java#1 $
 */
...
public abstract class DBInitTestBase {
	...
	public void setup() throws HibernateException, SQLException{
		...
		if(databaseM == null){
			databaseM = new DatabaseM(getDatabaseName(), null, dialect);
		}
