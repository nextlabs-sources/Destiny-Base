 ...
 * @author ihanen
 * @version $Id: //depot/Destiny/D_Nimbus/release/8.1.2/main/src/server/base/src/java/test/com/bluejungle/destiny/server/shared/registration/MockDSCFRegistrationListener.java#1 $:
 */
