 ...
 * 
 * @author ihanen
 * @version $Id: //depot/Destiny/D_Nimbus/release/8.1.2/main/src/server/container/shared/src/java/test/com/bluejungle/destiny/container/shared/storedresults/hibernateimpl/StoredQueryResultsStatisticsDOTest.java#1 $
 */
