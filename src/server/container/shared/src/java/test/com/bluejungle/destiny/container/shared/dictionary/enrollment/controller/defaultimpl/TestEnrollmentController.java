...
public class TestEnrollmentController extends BaseContainerSharedTestCase { 
    ...
    private class EnrollmentMock implements IEnrollment{
        ...
        public List<IEnrollmentDeltaCookie> getDeltaCookies() {
            throw new UnsupportedOperationException();
        }

        public IEnrollmentDeltaCookie getDeltaCookieByType(String type) {
            throw new UnsupportedOperationException();
        }
        
        public void setDeltaCookie(IEnrollmentDeltaCookie cookie) {
            throw new UnsupportedOperationException();
        }

        public void deleteDeltaCookies() {
            throw new UnsupportedOperationException();
        }
    }
