...
import com.nextlabs.destiny.container.shared.dictionary.enrollment.enroller.azuread.AzureADEnroller;
import com.nextlabs.destiny.container.shared.dictionary.enrollment.enroller.scim.SCIMEnroller;
...
public class EnrollmentTypeEnumType extends EnumBase {
	...
	public static final EnrollmentTypeEnumType AZURE_AD =
			new EnrollmentTypeEnumType("AZURE_AD", AzureADEnroller.class);
    ...
    public static final EnrollmentTypeEnumType SCIM =
            new EnrollmentTypeEnumType("SCIM", SCIMEnroller.class);
