...
/**
 * @author hchan
 * @version $Id: //depot/Destiny/D_Nimbus/release/8.1.2/main/src/server/container/shared/src/java/main/com/nextlabs/destiny/container/shared/inquirymgr/report/impl/ReportDataMangerStandalone.java#1 $
 */
...
public class ReportDataMangerStandalone extends BaseReportDataManager implements IReportDataManager{
    ...
    public ReportDataMangerStandalone() throws IOException, ClassNotFoundException {
        ...
        }else if(Class.forName("com.ibm.db2.jcc.DB2Driver").isAssignableFrom(clazz)){
            dbType = DB_TYPE_DB2;
        }else{
