...
public interface BasicLDAPEnrollmentProperties {
    ...
    /**
     * Should we delete inactive group membership info or merely mark it as
     * inactive. This value needs to be accessed by EnrollmentSession, which
     * is why it's defined there.
     */
    String DELETE_INACTIVE_GROUP_MEMBERS = IEnrollmentSession.DELETE_INACTIVE_GROUP_MEMBERS;
