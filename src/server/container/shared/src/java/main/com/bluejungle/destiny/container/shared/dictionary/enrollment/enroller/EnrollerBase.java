...
public abstract class EnrollerBase implements IEnroller {
    ...
    public boolean sync(IEnrollment enrollment, IDictionary dictionary)
        ...
        enrollment.updateIsSyncing(true);
        
        boolean isSuccess = false;
        synchronized (this) {
            IEnrollmentSession enrollmentSession = null;

            // This will be written back into the enrollment object
            String message = null;
            String resultStatus = IUpdateRecord.STATUS_SUCCEEDED;
            ...
            try{
                ...
                message = toMessage(e);
                resultStatus = IUpdateRecord.STATUS_FAILED;
                throw e;
                ...
                enrollment.updateIsSyncing(false);
            }
        }
        status = "post sync";
        postSync();
    ...
    protected void close(IEnrollmentSession enrollmentSession, boolean success, String message, Log log) {
