...
/**
 * @author atian
 * @version $Id: //depot/Destiny/D_Nimbus/release/8.1.2/main/src/server/container/shared/src/java/main/com/bluejungle/destiny/container/shared/dictionary/enrollment/enroller/sharepoint/impl/SharePointGroupSAXParser.java#1 $
 */
...
public class SharePointGroupSAXParser extends DefaultHandler {
    ...
    public void startElement(String namespaceURI, String localName, String qName, Attributes atts)
        ...
        if ( qName.equals(GROUP_TAG)) {
            ...
            String[] userList = users.getString();
            String usersForGroup = userList[groupIndex];
            try {
