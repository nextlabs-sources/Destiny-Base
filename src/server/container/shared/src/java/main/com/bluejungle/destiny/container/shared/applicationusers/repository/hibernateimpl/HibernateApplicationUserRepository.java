...
public class HibernateApplicationUserRepository implements IApplicationUserRepository {
    ...
    private static final String APPLICATION_USER_STATUS_PROPERTY = "status";
    ...
    /**
     * Search for active users given the (optional) specified search specifications
     *
     * @param searchSpecs a (possibly null) array of IUserSearchSpec objects
    ...
    public SortedSet<IApplicationUser> getApplicationUsers(IUserSearchSpec[] searchSpecs) throws ApplicationUserRepositoryAccessException {
        return getApplicationUsers(searchSpecs, true);
    }
    
    /**
     * Search for users given the (optional) specified search specifications
     *
     * @param searchSpecs a (possibly null) array of IUserSearchSpec objects
     * @param activeOnly if true, only active users will be returned
     * @return the matching users
     *
     * @see com.bluejungle.destiny.container.shared.applicationusers.repository.IApplicationUserRepository#getApplicationUsers(com.bluejungle.destiny.container.shared.applicationusers.core.IUserSearchSpec[], boolean)
     */
    public SortedSet<IApplicationUser> getApplicationUsers(IUserSearchSpec[] searchSpecs, boolean activeOnly) throws ApplicationUserRepositoryAccessException {
        ...
        try {
            ...
            if (activeOnly) {
                queryCriteria.add(buildActiveUserSearchCriterion());
            }
    ...
    private Criterion buildActiveUserSearchCriterion() {
        return Expression.ilike(APPLICATION_USER_STATUS_PROPERTY, "active");
    } 
