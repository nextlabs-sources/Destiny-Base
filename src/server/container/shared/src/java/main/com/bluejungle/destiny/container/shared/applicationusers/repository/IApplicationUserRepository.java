...
public interface IApplicationUserRepository {
    ...
    /**
     * Returns a collection of all the existing active application users
     * 
     * @param array of search specs
     * @throws ApplicationUserRepositoryAccessException
    ...
    /**
     * Returns a collection of all the existing application users, allowing you to specify active only or all users
     * 
     * @param array of search specs
     * @param search for active only or all users
     * @throws ApplicationUserRepositoryAccessException
     * @return set of all existing application users
     */
