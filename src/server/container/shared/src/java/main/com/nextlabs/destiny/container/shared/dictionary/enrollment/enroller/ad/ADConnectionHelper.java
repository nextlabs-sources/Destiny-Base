 ...
 *
 * @author amorgan
 * @version $Id: //depot/Destiny/D_Nimbus/release/8.1.2/main/src/server/container/shared/src/java/main/com/nextlabs/destiny/container/shared/dictionary/enrollment/enroller/ad/ADConnectionHelper.java#1 $:
 */
...
public class ADConnectionHelper {
    ...
    public static LDAPConnection createConnection() throws IOException {
        return createConnection(ConnectionType.UNENCRYPTED);
    }
    
    public static LDAPConnection createConnection(ConnectionType type) throws IOException {
        return createConnection(type, false);
    }
