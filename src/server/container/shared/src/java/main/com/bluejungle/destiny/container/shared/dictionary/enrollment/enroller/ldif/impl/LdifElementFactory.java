...
public class LdifElementFactory extends ElementCreator {
    ...
    /**
     * If true, then group members can come from *any* enrollment, not just the current
     * one. This requires different member lookup for setGroupMembers
     */
    ...
    public IMElementBase getElementByDN(String DN) throws DictionaryException {
        ...
        if(list == null || list.isEmpty() || !(list.get(0) instanceof IMElementBase)){
            return null;
        }
