 ...
 * 
 * @author ihanen
 * @version $Id: //depot/Destiny/D_Nimbus/release/8.1.2/main/src/server/container/dcsf/src/java/test/com/bluejungle/destiny/container/dcsf/MockRemoteEventDispatchWorkerImpl.java#1 $:
 */
