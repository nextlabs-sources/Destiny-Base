...
/**
 * @author hchan
 * @version $Id: //depot/Destiny/D_Nimbus/release/8.1.2/main/src/server/container/dac/src/java/test/com/nextlabs/destiny/container/dac/datasync/IndexesRebuildTest.java#1 $
 */

public class IndexesRebuildTest extends BaseDatasyncTestCase{

    public IndexesRebuildTest() {
        super(IndexesRebuildTest.class.getName());
    }
