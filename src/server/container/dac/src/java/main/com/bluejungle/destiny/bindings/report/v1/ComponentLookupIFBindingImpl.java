...
public class ComponentLookupIFBindingImpl implements ComponentLookupIF {
     ...
     */
    public ActionList getActions() throws AccessDeniedFault, ServiceNotReadyFault {
        ...
        ActionType[] actionArray = new ActionType[actionTypes.size()];
     ...
     */
    public HostList getHosts(HostQuerySpec querySpec) throws AccessDeniedFault, ServiceNotReadyFault {
        ...
        try {
            ...
            if (size > 0) {
                ...
                for (int index = 0; index < size; index++) {
                    ...
                    Host wsHost = new Host();
                    wsHost.setName(host.getName());
     ...
     * 
     */
    public PolicyList getPolicies(PolicyQuerySpec querySpec) throws AccessDeniedFault, ServiceNotReadyFault {
        ...
        try {
            ...
            if (size > 0) {
                ...
                for (int index = 0; index < size; index++) {
                    ...
                    Policy wsPolicy = new Policy();
                    wsPolicy.setName(policy.getName());
                    wsPolicy.setFolderName(policy.getFolderName());
...
//    }
     ...
     * 
     */
    public UserList getUsers(UserQuerySpec querySpec) throws AccessDeniedFault, ServiceNotReadyFault {
        ...
        try {
            ...
            if (size > 0) {
                ...
                for (int index = 0; index < size; index++) {
                    ...
                    wsUserArray[index] = new User();
                    wsUserArray[index].setFirstName(user.getFirstName());
                    wsUserArray[index].setLastName(user.getLastName());
                    wsUserArray[index].setDisplayName(user.getDisplayName());                    
                }
     ...
     * 
     */
    public UserClassList getUserClasses(UserClassQuerySpec querySpec) throws AccessDeniedFault, ServiceNotReadyFault {
        ...
        try {
            ...
            if (size > 0) {
                ...
                for (int index = 0; index < size; index++) {
                    ...
                    UserClass wsUserClass = new UserClass();
                    wsUserClass.setDisplayName(userClass.getDisplayName());
                    wsUserClass.setEnrollmentType(userClass.getEnrollmentType());
                    wsUserClass.setName(userClass.getName());
