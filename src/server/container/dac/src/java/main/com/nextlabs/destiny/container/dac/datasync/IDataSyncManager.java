...
public interface IDataSyncManager {
    ...
    PropertyKey<IHibernateRepository> DICTIONARY_DATASOURCE_CONFIG_PARAM = new PropertyKey<IHibernateRepository>("Dictionary DataSource");
    ...
    PropertyKey<Boolean>  SYNC_DELETE_AFTER_SYNC_PARAM = new PropertyKey<Boolean>(  "Sync Delete");
    ...
    PropertyKey<Calendar> ENROLLMENT_ARCHIVE_TIME_OF_DAY            = new PropertyKey<Calendar>("Enrollment Archive TimeOfDay");
    PropertyKey<BitSet> ENROLLMENT_ARCHIVE_DAY_OF_WEEK            = new PropertyKey<BitSet>("Enrollment Archive DayOfWeek");
    PropertyKey<BitSet> ENROLLMENT_ARCHIVE_DAY_OF_MONTH           = new PropertyKey<BitSet>("Enrollment Archive DayOfMonth");
    PropertyKey<Integer> ENROLLMENT_ARCHIVE_AGE_OF_EXPIRED_ENTRIES = new PropertyKey<Integer>("Enrollment Archive Age of Expired Entries");
    PropertyKey<Boolean>  ENROLLMENT_ARCHIVE_AUTO_ARCHIVE           = new PropertyKey<Boolean>("Enrollment Archive AutoArchive");
    PropertyKey<Long>     ENROLLMENT_ARCHIVE_TIMEOUT_PARAM          = new PropertyKey<Long>("Enrollment ArchiveTimeout");
