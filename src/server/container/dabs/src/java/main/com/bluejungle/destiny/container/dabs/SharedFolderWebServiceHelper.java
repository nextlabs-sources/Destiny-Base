...
public class SharedFolderWebServiceHelper {
    ...
    public static SharedFolderData convertFromSharedFolderData(ISharedFolderData data) {
        ...
        SharedFolderDataCookie sharedFolderDataCookie = new SharedFolderDataCookie();
        sharedFolderDataCookie.setTimestamp(data.getCookie().getTimestamp());
        result.setCookie(sharedFolderDataCookie);
