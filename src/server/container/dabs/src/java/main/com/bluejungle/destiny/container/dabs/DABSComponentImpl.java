...
import com.nextlabs.destiny.container.dabs.XACMLPoliciesProvider;
...
public class DABSComponentImpl extends BaseDCCComponentImpl {
    ...
    public void init() {
        ...
        try {
            heartbeatMgr.register(XACMLPoliciesRequestDTO.XACML_POLICIES_SERVICE, new XACMLPoliciesProvider());
        } catch (Exception ex) {
            // Too bad
        }
