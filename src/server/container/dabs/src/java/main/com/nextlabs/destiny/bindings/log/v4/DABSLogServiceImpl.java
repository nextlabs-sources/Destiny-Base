...
import com.nextlabs.destiny.interfaces.log.v4.LogServiceIF;
import com.nextlabs.destiny.types.log.v4.LogStatus;
...
public class DABSLogServiceImpl implements LogServiceIF {
    ...
    public LogStatus logPolicyAssistant(String request) {
        ...
        } catch (IOException | ClassNotFoundException | ServiceNotReadyFault e) {
