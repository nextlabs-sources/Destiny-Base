 ...
 * 
 * @author rlin
 * @version $Id: //depot/Destiny/D_Nimbus/release/8.1.2/main/src/server/container/dabs/src/java/main/com/nextlabs/destiny/bindings/log/v2/DABSLogServiceWSConverter.java#1 $
 */
