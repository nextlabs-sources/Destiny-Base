 ...
 * @author ihanen
 * @version $Id: //depot/Destiny/D_Nimbus/release/8.1.2/main/src/server/container/dabs/src/java/test/com/bluejungle/destiny/container/dabs/PolicyDeploymentServiceTest.java#1 $ 
 */
public class PolicyDeploymentServiceTest extends BaseDestinyTestCase {
    ...
    protected void setUp() throws ServiceException {
        ...
        locator.setPolicyDeploymentServiceIFPortEndpointAddress("http://localhost:8081/dabs/services/PolicyDeploymentService");
