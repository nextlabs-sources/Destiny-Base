 ...
 * 
 * @author rlin
 * @version $Id: //depot/Destiny/D_Nimbus/release/8.1.2/main/src/server/container/dabs/src/java/test/com/nextlabs/destiny/bindings/log/v2/LogServiceTest.java#1 $
 */
...
public class LogServiceTest extends BaseDabsComponentTest {
    ...
    public LogServiceTest(String testName) {
        ...
        try {
            ...
            locator.setLogServiceIFPortV2EndpointAddress("http://localhost:8081/dabs/services/LogService.v2");
