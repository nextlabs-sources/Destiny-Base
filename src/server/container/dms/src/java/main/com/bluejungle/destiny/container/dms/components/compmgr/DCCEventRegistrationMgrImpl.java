...
public class DCCEventRegistrationMgrImpl implements IDCCEventRegistrationMgr {
    ...
    /**
     * Returns a List of event registrations that occured for all
     * other components since 'date'. This is used to tell component
     * XYZ about everything else that has happened
     * 
     * @param date
     * @param exceptComponent
     * @return List of EventRegistrations
     * @throws DataSourceException
     */
    public List<EventRegistration> getRegistrationsSince(long timestamp, ComponentDO exceptComponent) throws DataSourceException {
        ...
        try {
            ...
            Criterion exceptForListener = Expression.not(Expression.eq("consumer", exceptComponent));
    ...
    /**
     * Returns a List of event registrations made by a particular component ever in the past
     *
     * @param component
    ...
    public List<EventRegistration> getRegistrationsForComponentEver(ComponentDO component) throws DataSourceException {
        return getRegistrationsForComponentSince(0, component);
    }
    
    /**
     * Returns a List of event registrations made by a particular component since
     * 'timestamp'.
     *
     * @param date
     * @param component
    ...
    public List<EventRegistration> getRegistrationsForComponentSince(long timestamp, ComponentDO component) throws DataSourceException {
        ...
        try {
            ...
            Criterion forListener = Expression.eq("consumer", component);
            registrationCriteria.add(forListener);
            registrations = registrationCriteria.list();
        } catch (HibernateException e) {
            throw new DataSourceException(e);
        }
