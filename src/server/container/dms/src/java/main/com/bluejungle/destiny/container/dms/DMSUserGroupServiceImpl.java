...
import com.bluejungle.destiny.services.management.types.UniqueConstraintViolationFault;
...
public class DMSUserGroupServiceImpl implements UserGroupServiceIF {
    ...
    public UserGroupReducedList getAllUserGroups() throws ServiceNotReadyFault, CommitFault, UnauthorizedCallerFault {
    ...
    public UserGroupReducedList getUserGroupsForUser(UserDTO user) throws ServiceNotReadyFault, CommitFault, UnauthorizedCallerFault {
        UserGroupReducedList listToReturn;

        IApplicationUserManager applicationUserManager = getApplicationUserManager();
        try {
            Collection userGroups = applicationUserManager.getAccessGroupsContainingUser(user.getId().getID().longValue());
            listToReturn = buildUserGroupReducedList(userGroups);
        } catch (UserManagementAccessException exception) {
    ...
    public UserGroupDTO getUserGroup(ID userGroupId) throws ServiceNotReadyFault, UnknownEntryFault, CommitFault, UnauthorizedCallerFault {
        UserGroupDTO groupToReturn = null;

        try {
            IAccessGroup accessGroup = getAccessGroup(userGroupId.getID().longValue());
     ...
     */
    public UserDTOList getUsersInUserGroup(ID userGroupId) throws ServiceNotReadyFault, UnknownEntryFault, CommitFault, UnauthorizedCallerFault {
        UserDTOList listToReturn;
        UserDTO[] usersToReturnInList;

        IApplicationUserManager applicationUserManager = getApplicationUserManager();
        try {
            Collection users = applicationUserManager.getUsersInAccessGroup(userGroupId.getID().longValue());
            ...
            listToReturn.setUsers(usersToReturnInList);
        } catch (GroupNotFoundException exception) {
            getLog().error("Failed to retrieve user group with ID, " + userGroupId + ".  A group with this id was not found", exception);
            throw new UnknownEntryFault();
        } catch (UserManagementAccessException exception) {
    ...
    public void addUsersToUserGroup(ID userGroupId, IDList userIds) throws ServiceNotReadyFault, UnknownEntryFault, CommitFault, UnauthorizedCallerFault {
        if (userIds.getIDList() != null) {
            long[] usersIdsLongArray = toLongArray(userIds.getIDList());

            IApplicationUserManager applicationUserManager = getApplicationUserManager();

            try {
                applicationUserManager.addUsersToAccessGroup(userGroupId.getID().longValue(), usersIdsLongArray);
    ...
    public void removeUsersFromUserGroup(ID userGroupId, IDList userIds) throws ServiceNotReadyFault, UnknownEntryFault, CommitFault, UnauthorizedCallerFault {
        if (userIds.getIDList() != null) {
            long[] usersIdsLongArray = toLongArray(userIds.getIDList());
            ...
            try {
                applicationUserManager.removeUsersFromAccessGroup(userGroupId.getID().longValue(), usersIdsLongArray);
            } catch (AccessGroupModificationFailedException exception) {
    ...
    public DefaultAccessAssignmentList getDefaultAccessAssignments(ID userGroupId) throws ServiceNotReadyFault, UnknownEntryFault, CommitFault, UnauthorizedCallerFault {
        ...
        try {
            IAccessGroup userGroup = getAccessGroup(userGroupId.getID().longValue());
    ...
    public void setDefaultAccessAssignments(ID userGroupId, DefaultAccessAssignmentList defaultAccessAssignments) throws ServiceNotReadyFault, UnknownEntryFault, CommitFault, UnauthorizedCallerFault {
        ...
        try {
            ...
            if (defaultAccessAssignmentsToSet != null) {
                for (int i = 0; i < defaultAccessAssignmentsToSet.length; i++) {
                    ...
                    Long nextPrincpalId = new Long(nextPrincipal.getID().getID().longValue());
            ...
            getApplicationUserManager().setDefaultAccessControlAssignmentForGroup(userGroupId.getID().longValue(), pqlToSet);
        } catch (AccessGroupModificationFailedException exception) {
    ...
    public void linkExternalGroups(ExternalUserGroupList externalGroupList) throws ServiceNotReadyFault, CommitFault, UnauthorizedCallerFault {
    ...
    public void updateGroup(UserGroupDTO userGroupToUpdate) throws ServiceNotReadyFault, CommitFault, UnauthorizedCallerFault, UniqueConstraintViolationFault {
        IApplicationUserManager applicationUserManager = getApplicationUserManager();

        try {
            applicationUserManager.updateGroup(userGroupToUpdate.getId().getID().longValue(), userGroupToUpdate.getTitle(), userGroupToUpdate.getDescription());
            ...
            throw new UniqueConstraintViolationFault("title");
        } catch (GroupNotFoundException exception) {
    ...
    public void deleteGroup(ID userGroupId) throws ServiceNotReadyFault, UnknownEntryFault, CommitFault, UnauthorizedCallerFault {
        IApplicationUserManager applicationUserManager = getApplicationUserManager();

        try {
            applicationUserManager.deleteGroup(userGroupId.getID().longValue());
        } catch (GroupNotFoundException exception) {
            // Ignore
    ...
    public UserGroupQueryResults runUserGroupQuery(UserGroupQuerySpec userGroupQuerySpec) throws ServiceNotReadyFault, CommitFault, UnauthorizedCallerFault {
    ...
    public ExternalUserGroupQueryResults runExternalUserGroupQuery(UserGroupQuerySpec userGroupQueryTermSpec) throws ServiceNotReadyFault, CommitFault, UnauthorizedCallerFault {
    ...
    public UserGroupDTO createUserGroup(UserGroupInfo userGroupInfo) throws ServiceNotReadyFault, CommitFault, UnauthorizedCallerFault, UniqueConstraintViolationFault {
        UserGroupDTO groupToReturn = null;
    ...
    private DefaultAccessAssignment buildDefaultAccessAssignment(UserAccess userAccessPQLComponent) throws UserManagementAccessException, UserNotFoundException, ServiceNotReadyFault, NumberFormatException {
        ...
        ID newId = new ID();
        newId.setID(principalId);
        
        Principal accessUserPrincipal = new Principal();
        accessUserPrincipal.setID(newId);
        accessUserPrincipal.setDisplayName(principalDisplayName);
        accessUserPrincipal.setType(PrincipalType.USER);
        ...
        accessAssignment.setPrinciapl(accessUserPrincipal);
        accessAssignment.setDefaultAccess(groupAccessList);
    ...
    private DefaultAccessAssignment buildDefaultAccessAssignment(GroupAccess groupAccessPQLComponent) throws ServiceNotReadyFault, UserManagementAccessException, GroupNotFoundException {
        ...
        Principal accessGroupPrincipal = new Principal();
        accessGroupPrincipal.setID(newId);
        accessGroupPrincipal.setDisplayName(principalDisplayName);
        accessGroupPrincipal.setType(PrincipalType.USER_GROUP);
        
        Collection actions = groupAccessPQLComponent.getActions();
        AccessList groupAccessList = buildAccessList(actions);
        
        DefaultAccessAssignment accessAssignment = new DefaultAccessAssignment();
        accessAssignment.setPrinciapl(accessGroupPrincipal);
        accessAssignment.setDefaultAccess(groupAccessList);
    ...
    private UserGroupReducedList buildUserGroupReducedList(Collection userGroups) {
        ...
        UserGroupReducedList userGrpList = new UserGroupReducedList();
        userGrpList.setUserGroupReduced(userGroupsToReturnInList);
        return userGrpList;
    }
    ...
    private UserGroupReduced buildUserGroupReduced(IAccessGroup sourceGroup) {
        ...
        UserGroupReduced usrGrp = new UserGroupReduced();
        ID id2 = new ID();
        id2.setID(id);
        usrGrp.setId(id2);
        usrGrp.setTitle(title);
        ByteArrayDataSource ds = new ByteArrayDataSource(externalId);
        usrGrp.setExternalId(new DataHandler(ds));
        usrGrp.setDomain(domain);
        usrGrp.setExternallyLinked(isExternallyLinked);
        usrGrp.setOrphaned(isOrphaned);
    ...
    private ExternalUserGroupList buildExternalUserGroupList(Collection userGroups) {
        ...
        ExternalUserGroupList extUsrGrpLst = new ExternalUserGroupList();
        extUsrGrpLst.setExternalUserGroup(userGroupsToReturnInList);
        return extUsrGrpLst;
    }
    ...
    private ExternalUserGroup buildExternalUserGroup(IExternalGroup sourceGroup) {
        ...
        ExternalUserGroup extUsrGrp = new ExternalUserGroup();
        extUsrGrp.setDomain(domain);
        ByteArrayDataSource ds = new ByteArrayDataSource(externalId);
        extUsrGrp.setExternalId(new DataHandler(ds));
        extUsrGrp.setTitle(title);
    ...
    private UserGroupDTO buildUserGroupDTO(IAccessGroup sourceGroup) {
        ...
        UserGroupDTO usrGrpDTO = new UserGroupDTO();
        usrGrpDTO.setTitle(title);
        ID id2 = new ID();
        id2.setID(id);
        usrGrpDTO.setId(id2);
        usrGrpDTO.setQualifiedExternalName(qualifiedExternalName);
        usrGrpDTO.setDescription(description);
        usrGrpDTO.setExternallyLinked(isExternallyLinked);
        ByteArrayDataSource ds = new ByteArrayDataSource(externalId);
        usrGrpDTO.setExternalID(new DataHandler(ds));
        
        return usrGrpDTO;
    }

    /**
     * Utility method to translate an ID array to a long array
     * 
     * @param userIdsArray
     *            the array to translate
     * @return the translated array
     */
    private long[] toLongArray(ID[] userIdsArray) {
        ...
        for (int i = 0; i < userIdsArray.length; i++) {
            usersIdsLongArray[i] = userIdsArray[i].getID().longValue();
        }
    ...
    private class ExternalGroupLinkDataImpl implements IExternalGroupLinkData {
        ...
        public byte[] getExternalId() {
            return ConverterUtil.getStringFromDatahandler(group.getExternalId()).getBytes();
        }
    ...
    private static class DefaultAccessAssignmentComparator implements Comparator {
        ...
        public int compare(Object objectOne, Object objectTwo) {
            ...
            if (displayNameOne.equals(displayNameTwo)) {
                ...
                // compare the id's
                BigInteger principalOneId = defaultAccessAssignmentOne.getPrinciapl().getID().getID();
                BigInteger principalTwoId = defaultAccessAssignmentTwo.getPrinciapl().getID().getID();
