...
public class DMSProfileServiceImpl implements ProfileServiceIF {
    ...
    public AgentProfileDTO addAgentProfile(AgentProfileInfo agentProfileToAdd) throws CommitFault, ServiceNotReadyFault, UniqueConstraintViolationFault {
        ...
        try {
            ...
            throw new UniqueConstraintViolationFault(StringUtils.join(exception.getConstrainingFields(), "\n"));
    ...
    public CommProfileDTO addCommProfile(CommProfileInfo commProfileToAdd) throws CommitFault, ServiceNotReadyFault, UniqueConstraintViolationFault, UnknownEntryFault {
     ...
     */
    public UserProfileDTO addUserProfile(UserProfileInfo userProfileToAdd) throws CommitFault, ServiceNotReadyFault, UniqueConstraintViolationFault {
     ...
     */
    public void updateAgentProfile(AgentProfileDTO profileInfoToUpdate) throws CommitFault, UnknownEntryFault, ServiceNotReadyFault {
        ...
        try {
            ...
            agentProfileToUpdate.setLogViewingEnabled(profileInfoToUpdate.getLogViewingEnabled());
            agentProfileToUpdate.setTrayIconEnabled(profileInfoToUpdate.getTrayIconEnabled());
     ...
     */
    public void updateCommProfile(CommProfileDTO profileInfoToUpdate) throws CommitFault, UnknownEntryFault, ServiceNotReadyFault {
        ...
        try {
            ...
            commProfileToUpdate.setPushEnabled(profileInfoToUpdate.getPushEnabled());
     ...
     */
    public void updateUserProfile(UserProfileDTO userProfileDTOToUpdate) throws CommitFault, UnknownEntryFault, ServiceNotReadyFault {
     ...
     */
    public AgentProfileDTOList getAgentProfiles(AgentProfileDTOQuery agentProfileQuery) throws ServiceNotReadyFault, CommitFault {
     ...
     */
    public CommProfileDTOList getCommProfiles(CommProfileDTOQuery commProfileDTOQuery) throws CommitFault, ServiceNotReadyFault {
     ...
     */
    public UserProfileDTOList getUserProfiles(UserProfileDTOQuery userProfileQuery) throws CommitFault, ServiceNotReadyFault {
     ...
     */
    public void removeAgentProfile(long id) throws CommitFault, UnknownEntryFault, ServiceNotReadyFault {
        IProfileManager profileManager = getProfileManager();
        try {
            profileManager.deleteAgentProfile(new Long(id));
        } catch (DataSourceException exception) {
            throw new CommitFault(exception);
        }
    }
     ...
     */
    public void removeCommProfile(long id) throws UnknownEntryFault, UnknownEntryFault, ServiceNotReadyFault {
        IProfileManager profileManager = getProfileManager();
        try {
            profileManager.deleteCommProfile(new Long(id));
        } catch (DataSourceException exception) {
            // Not a great choice, but it's not clear what we can throw that's better
            throw new UnknownEntryFault(exception);
        }
    }
     ...
     */
    public void removeUserProfile(long id) throws CommitFault, UnknownEntryFault, ServiceNotReadyFault {
        IProfileManager profileManager = getProfileManager();
        try {
     ...
     */
    public ActivityJournalingSettingsDTOList getActivityJournalingSettings(String agentTypeId) throws CommitFault, ServiceNotReadyFault {
        IAgentManager agentManager = getAgentManager();
    ...
    private IAgentProfileDO buildAgentProfileLastResult(AgentProfileDTOQuery agentProfileQuery) {
        ...
        if (fromDTOResult != null) {
            ...
            boolean fromIsDefaultProfile = fromDTOResult.getDefaultProfile();
            boolean fromDTOResultLogViewingEnabled = fromDTOResult.getLogViewingEnabled();
            boolean fromDTOResultTrayIconEnabled = fromDTOResult.getTrayIconEnabled();
    ...
    private ICommProfileDO buildCommProfileLastResult(CommProfileDTOQuery commProfileQuery) throws ServiceNotReadyFault {
        ...
        if (fromDTOResult != null) {
            ...
            boolean fromDTOPushEnabled = fromDTOResult.getPushEnabled();
            boolean fromIsDefaultProfile = fromDTOResult.getDefaultProfile();

            byte[] fromDTOPasswordHash = new byte[0];
            try {
                InputStream is = fromDTOResult.getPasswordHash().getInputStream();
                ByteArrayOutputStream buffer = new ByteArrayOutputStream();
                int bytesRead = 0;
                byte[] tmpData = new byte[256];
                while((bytesRead = is.read(tmpData, 0, tmpData.length)) != -1) {
                    buffer.write(tmpData, 0, bytesRead);
                }
                buffer.flush();
                
                fromDTOPasswordHash = buffer.toByteArray();
            } catch (IOException io) {
                // Shouldn't happen
                LOG.error("Unable to convert password hash", io);
            }
            
            // FIX ME -!!!!!!!!!!!!!!!!!!!!!!!! shouldn't have access to the DO
            // implementation
            //
            // (To ensure that a piece of code is never, ever, ever changed, just
            // write FIX ME immediately above it)
    ...
    private class AgentProfileDataImpl extends BaseProfileDataImpl implements IAgentProfileData {
        ...
        public boolean isLogViewingEnabled() {
            return this.agentProfileInfo.getLogViewingEnabled();
        }
        ...
        public boolean isTrayIconEnabled() {
            return this.agentProfileInfo.getTrayIconEnabled();
        }
    }
    ...
    private class CommProfileDataImpl extends BaseProfileDataImpl implements ICommProfileData {
        ...
        public boolean isPushEnabled() {
            return this.commProfileInfo.getPushEnabled();
        }
