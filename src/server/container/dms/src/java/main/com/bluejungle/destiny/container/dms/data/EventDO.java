...
public class EventDO {
    ...
    private long id;
    private String name;
    private Map<Long, EventRegistration> registrations;
     ...
     */
    public Map<Long, EventRegistration> getRegistrations() {
     ...
     * @param event
     */
    public synchronized void addRegistration(ComponentDO listener) {
        if (this.registrations == null) {
            this.registrations = new HashMap<Long, EventRegistration>();
        }

        EventRegistration registration = this.registrations.get(listener.getId());
     ...
     * @param listener
     */
    public synchronized void disableRegistration(ComponentDO listener) {
        if (this.registrations != null) {
            EventRegistration registration = this.registrations.get(listener.getId());
     ...
     * @param listener
     */
    public synchronized void deleteRegistration(ComponentDO listener) {
        if (this.registrations != null) {
            EventRegistration registration = this.registrations.get(listener.getId());
