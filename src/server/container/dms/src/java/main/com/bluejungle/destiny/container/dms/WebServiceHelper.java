...
public class WebServiceHelper {
        ...
        if (wsSortTermList != null) {
            ...
            if (wsTerms != null) {
                ...
                for (int i = 0; i < size; i++) {
                    ...
                    result.addSortSpecTerm(new AgentSortTermImpl(AgentMgrSortFieldType.fromString(wsTerm.getField().getValue()), wsTerm.getAscending()));
                }
            }
        }
        return result;
    ...
    public static DCCRegistrationStatus convertDCCRegistrationStatusToServiceType(IDCCRegistrationStatus status) {
        ...
        result.setResult(DMSRegistrationOutcome.Factory.fromValue(status.getRegistrationResult().getName()));
    ...
    public static SharedFolderData convertFromSharedFolderData(ISharedFolderData data) {
        ...
        SharedFolderDataCookie cook = new SharedFolderDataCookie();
        cook.setTimestamp(data.getCookie().getTimestamp());
        result.setCookie(cook);
