 ...
 * 
 * @author pkeni
 * @version $Id: //depot/Destiny/D_Nimbus/release/8.1.2/main/src/server/container/dms/src/java/test/com/bluejungle/destiny/container/dms/UserRoleServiceTest.java#1 $
 */
public class UserRoleServiceTest extends BaseDMSComponentTest {
    ...
    public void setUp() throws Exception {
        ...
        dmsUserRoleSvcLocator.setUserRoleServiceIFPortEndpointAddress("http://localhost:8081/dms/services/UserRoleService");
