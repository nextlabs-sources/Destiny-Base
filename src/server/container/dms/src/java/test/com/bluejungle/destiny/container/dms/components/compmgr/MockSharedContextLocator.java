 ...
 * 
 * @author sgoldstein
 * @version $Id: //depot/Destiny/D_Nimbus/release/8.1.2/main/src/server/container/dms/src/java/test/com/bluejungle/destiny/container/dms/components/compmgr/MockSharedContextLocator.java#1 $
 */
