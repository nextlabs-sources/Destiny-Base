 ...
 * 
 * @author sgoldstein
 * @version $Id: //depot/Destiny/D_Nimbus/release/8.1.2/main/src/server/container/dms/src/java/test/com/bluejungle/destiny/container/dms/ComponentServiceTest.java#1 $
 */
public class ComponentServiceTest extends BaseDMSComponentTest {
    ...
    public void setUp() throws Exception {
        ...
        serviceLocator.setComponentServiceIFPortEndpointAddress("http://localhost:8081/dms/services/ComponentService");
