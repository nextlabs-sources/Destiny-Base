 ...
 * 
 * @author sgoldstein
 * @version $Id: //depot/Destiny/D_Nimbus/release/8.1.2/main/src/server/container/dps/src/java/test/com/bluejungle/destiny/container/policyDeployMgr/MockSharedContextLocator.java#1 $
 */
