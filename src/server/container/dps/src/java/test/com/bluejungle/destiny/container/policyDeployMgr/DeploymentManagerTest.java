...
//            			"ICENet Server",
//            			new org.apache.axis2.databinding.types.URI("http://dummyHost/listener/" + i),
//            			new org.apache.axis2.databinding.types.URI("http://dummyHost/component/" + i),
//            			new Version(),
...
//                s.save(newDabs);
    ...
    private ComponentServiceStub getComponentServiceInterface() throws IOException, AxisFault {
        if (this.componentService == null) {
            ...
            JSSESocketFactoryWrapper.attachToStub(this.componentService);
        }
