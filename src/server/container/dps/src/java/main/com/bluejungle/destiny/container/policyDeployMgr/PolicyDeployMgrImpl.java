...
public class PolicyDeployMgrImpl implements IPolicyDeployMgr, ILogEnabled, IConfigurable,
    ...
    private void assignAgentProcessors(Long deploymentId) throws HibernateException, CommitFault {
     ...
     * @throws CommitFault 
     */
    private void assignAgentProcessors(Long deploymentId, String componentType, List<Long> profileIds) throws HibernateException, CommitFault {
        ...
        try {
            ...
            t.commit();
        } catch (RemoteException | UnauthorizedCallerFault | ServiceNotReadyFault e){
    ...
    private class DeploymentScheduledTask extends TimerTask {
        ...
        public void run() {
            ...
            } catch (HibernateException | CommitFault e) {
    ...
    private class AgentHandlerMap {
        ...
        public void refresh() {
            ...
            } catch (RemoteException | UnauthorizedCallerFault | CommitFault | ServiceNotReadyFault re) {
    ...
    private ComponentServiceStub getComponentServiceInterface() throws IOException {
        if (componentService == null) {
            ...
            JSSESocketFactoryWrapper.attachToStub(componentService);
        }
