 ...
 * 
 * @author sgoldstein
 * @version $Id: //depot/Destiny/D_Nimbus/release/8.1.2/main/src/server/container/base/src/java/test/com/bluejungle/destiny/container/dcc/IDCCComponentConfigResourceLocator.java#1 $
 */
