...
public class ServerRelativeFolders {
    ...
    public static final ServerRelativeFolders ENROLLMENT_FOLDER     = new ServerRelativeFolders("../tools/enrollment");
    ...
    public static final ServerRelativeFolders XACML_POLICIES_FOLDER = new ServerRelativeFolders("xacmlpolicies");
