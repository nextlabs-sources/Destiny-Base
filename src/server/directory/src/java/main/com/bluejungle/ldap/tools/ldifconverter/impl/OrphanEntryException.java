...
/**
 * @author safdar
 * @version $Id: //depot/Destiny/D_Nimbus/release/8.1.2/main/src/server/directory/src/java/main/com/bluejungle/ldap/tools/ldifconverter/impl/OrphanEntryException.java#1 $
 */
