...
public class SecureWsdl2javaAntTask extends AntCodegenTask {

    private static final String SEPARATOR = ";";
    private static final String EQUAL = "=";
    private static String trustedCallers;
    private static String accessList;
    private static Map<String, String> parsedAccessList;
     ...
     */
    protected static void validate() throws BuildException {
     ...
     */
    public static Map<String, String> getAccessList() {
