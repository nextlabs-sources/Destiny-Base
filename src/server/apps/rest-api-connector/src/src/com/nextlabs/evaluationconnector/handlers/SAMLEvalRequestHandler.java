 ...
 *
 * @author amorgan
 * @version $Id: //depot/Destiny/D_Nimbus/release/8.1.2/main/src/server/apps/rest-api-connector/src/src/com/nextlabs/evaluationconnector/handlers/SAMLEvalRequestHandler.java#1 $:
 */
