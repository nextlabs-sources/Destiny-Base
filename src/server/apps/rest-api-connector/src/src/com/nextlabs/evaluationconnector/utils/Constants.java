...
public interface Constants {
	...
	public static final String OAUTH_TOKEN_REQ_SERVICE = "TOKEN";
    ...
    public static final String OAUTH_TOKEN_CLIENT_ID = "client_id";
    public static final String OAUTH_TOKEN_CLIENT_SECRET = "client_secret";
    public static final String OAUTH_TOKEN_EXPIRES_IN = "expires_in";
	...
	public static final String PERMISSIONS_EVAL_TIME = "permissions_eval_time";
