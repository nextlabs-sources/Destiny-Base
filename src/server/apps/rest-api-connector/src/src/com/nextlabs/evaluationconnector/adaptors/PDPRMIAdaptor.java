...
public class PDPRMIAdaptor implements PDPAdapter {
    ...
    public IWrappedXACMLResponse evaluate(String data, String dataType) throws EvaluationConnectorException {
		log.warn("evaluate(String, String) not implemented for RMI-API");
		throw new EvaluationConnectorException("evaluate(String, String) not implemented for RMI-API");
    }
    ...
    public PermissionsResponse evaluatePermissions(List<PDPRequest> pdpPermissionsRequests) throws EvaluationConnectorException {
		log.warn("evaluatePermissions(List<PDPRequest>) not implemented for RMI-API");
		throw new EvaluationConnectorException("evaluatePermissions(List<PDPRequest>) not implemented for RMI-API");
    }
