...
public class RemoteLoginManager implements ILoginMgr, ILogEnabled, IConfigurable {
    ...
    public ILoggedInUser login(ILoginInfo loginInfo) throws LoginException {
        ...
        } catch (InvalidPasswordFault exception) {
        	throw new LoginException("Access denied for user, wrong username or password", exception);
        }
     ...
     * @throws com.bluejungle.destiny.interfaces.secure_session.v1.AccessDeniedFault 
     * @throws InvalidPasswordFault 
     */
    private SecureSession initSession(String username, String password) throws RemoteException, MalformedURLException, InvalidPasswordFault, AccessDeniedFault {
        ...
        try {
            ...
            SecureSessionServiceStub secureSessionService = getSecureSessionService(secureSessionServiceEndpoint);
     ...
     * @throws RemoteException
     */
    protected SecureSessionServiceStub getSecureSessionService(String serviceLocation) throws RemoteException {
    	SecureSessionServiceStub locator = new SecureSessionServiceStub(serviceLocation);

        try {
            JSSESocketFactoryWrapper.attachToStub(locator);
        } catch (IOException ioe) {
            throw new RemoteException("Unable to create socket factory for stub", ioe);
        }
