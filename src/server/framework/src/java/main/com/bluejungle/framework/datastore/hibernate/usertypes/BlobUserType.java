 ...
 * @author hchan
 *
 * This provides a wrapper around the BLOB type to work around a
 * Postgres bug (see 15432). Postgres doesn't provide a native BLOB
 * type, preferring bytea, but Postgres's handling of null as a bytea
 * is a problem.
 *
 * TODO - has this been resolved in later versions of the Postgres jdbc
 * driver? It's been a long time since we checked
 */
...
public class BlobUserType extends AbstractType {
    ...
    public Object nullSafeGet(ResultSet rs, String name, SessionImplementor session, Object owner)
        ...
        if (rs instanceof org.postgresql.jdbc.PgResultSet) {
            isPostgre = true;
            ...
            if (inner instanceof org.postgresql.jdbc.PgResultSet) {
                isPostgre = true;
            }
        }
