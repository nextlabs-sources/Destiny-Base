...
/**
 * @author atian
 * @version $Id: //depot/Destiny/D_Nimbus/release/8.1.2/main/src/server/ind/src/java/main/com/bluejungle/ind/IExternalResourceTypes.java#1 $
 */

public interface IExternalResourceTypes {
