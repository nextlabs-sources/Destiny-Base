...
import com.microsoft.schemas.sharepoint.soap.GetWebCollectionDocument;
import com.microsoft.schemas.sharepoint.soap.GetWebCollectionResponseDocument;
import com.microsoft.schemas.sharepoint.soap.GetWebCollectionResponseDocument.GetWebCollectionResponse;
...
public class SharePointDataSource extends DataSource {
    ...
    public List<IExternalResource> getSitesList(String parentSite) throws INDException {
        ...
        try {
        	WebsStub soapStub = SharePointDataSourceConnectionTester.getWebsSoap12Stub(
                    parentSite, connection.getUserName(),
                    connection.getPassword(), connection.getDomainName() );
            GetWebCollectionResponseDocument value = soapStub.getWebCollection((GetWebCollectionDocument)GetWebCollectionDocument.Factory.newInstance());
            GetWebCollectionResponse webs = value.getGetWebCollectionResponse();
            
            //TODO : IMPLEMENT THIS
//            if ( webs != null ) {
//                MessageElement[] elements = webs.getGetWebCollectionResult();
//
//                for (MessageElement parentMsg : elements) {
//                    Iterator itor = parentMsg.getChildElements();
//                    while( itor.hasNext() ) {
...
//            }
    ...
    public List<IExternalResource> getLists(String parentSite) throws INDException {
        ...
        try {
            ...
            SiteDataStub soapStub = SharePointDataSourceConnectionTester.getSiteDataSoap12Stub(
                        parentSite, connection.getUserName(),
                        connection.getPassword(), connection.getDomainName() ); 
    ...
    public List<IExternalResource> getListItems(String id) throws INDException {
        ...
        try {
            ...
            GetListItems listItem = new GetListItems();
            listItem.setStrListName(id);
            
            value = soapStub.getListItems(listItem);
