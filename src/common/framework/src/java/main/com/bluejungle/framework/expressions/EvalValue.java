...
public class EvalValue implements IEvalValue {
    ...
    public static IEvalValue build(PartialDateTime dv) {
        return new EvalValue(ValueType.PARTIAL_DATE_TIME, dv);
    }

    public static IEvalValue build(LocalDateTime ldt) {
        return new EvalValue(ValueType.PARTIAL_DATE_TIME, ldt);
    }
    
    public static IEvalValue build(ZonedDateTime zdt) {
        return new EvalValue(ValueType.ZONED_DATE_TIME, zdt);
    }
