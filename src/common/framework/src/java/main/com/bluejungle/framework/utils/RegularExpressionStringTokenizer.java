 ...
 * @author sgoldstein
 * @version $Id: //depot/Destiny/D_Nimbus/release/8.1.2/main/src/common/framework/src/java/main/com/bluejungle/framework/utils/RegularExpressionStringTokenizer.java#1 $
 */

public class RegularExpressionStringTokenizer implements Iterator<String> {
