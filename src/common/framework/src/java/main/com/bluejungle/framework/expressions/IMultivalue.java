...
public interface IMultivalue extends Iterable<IEvalValue> {
     ...
     *
     * We can't use an anonymous class because it must implement two interfaces
     */
    IMultivalue EMPTY = new EmptyMultivalue();

    class EmptyMultivalue implements IMultivalue, Serializable {
