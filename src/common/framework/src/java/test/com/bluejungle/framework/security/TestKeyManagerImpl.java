...
public class TestKeyManagerImpl extends TestCase {
    ...
    private static final String RELATIVE_KEYSTORE_FILE_NAME = "/test_files/" + TestKeyManagerImpl.class.getPackage().getName().replaceAll("[.]", "/") + "/keystore.p12";
    private static final String RELATIVE_TRUSTSTORE_FILE_NAME = "/test_files/" + TestKeyManagerImpl.class.getPackage().getName().replaceAll("[.]", "/") + "/truststore.p12";
    private static final String RELATIVE_SECRET_KEYSTORE_FILE_NAME = "/test_files/" + TestKeyManagerImpl.class.getPackage().getName().replaceAll("[.]", "/") + "/secretkeystore.p12";
    private static final String RELATIVE_EMPTY_SECRET_KEYSTORE_FILE_NAME = "/test_files/" + TestKeyManagerImpl.class.getPackage().getName().replaceAll("[.]", "/") + "/emptysecretkeystore.p12";
    ...
    protected void setUp() throws Exception {
        ...
        keyStoreFileInfo.add(new KeyManagerImpl.KeystoreFileInfo("privateKeyStore", this.baseDir + RELATIVE_KEYSTORE_FILE_NAME, "pkcs12", "password"));
        keyStoreFileInfo.add(new KeyManagerImpl.KeystoreFileInfo("publicTrustStore", this.baseDir + RELATIVE_TRUSTSTORE_FILE_NAME, "pkcs12", "password"));
        keyStoreFileInfo.add(new KeyManagerImpl.KeystoreFileInfo("secretKeyStore", this.baseDir + RELATIVE_SECRET_KEYSTORE_FILE_NAME, "pkcs12", "password"));
        keyStoreFileInfo.add(new KeyManagerImpl.KeystoreFileInfo("emptySecretKeyStore", this.baseDir + RELATIVE_EMPTY_SECRET_KEYSTORE_FILE_NAME, "pkcs12", "password"));
