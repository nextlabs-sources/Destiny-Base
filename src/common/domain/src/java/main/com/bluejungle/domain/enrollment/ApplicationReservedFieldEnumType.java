 ...
 *
 * @author safdar, atian
 * @version $Id: //depot/Destiny/D_Nimbus/release/8.1.2/main/src/common/domain/src/java/main/com/bluejungle/domain/enrollment/ApplicationReservedFieldEnumType.java#1 $
 */
