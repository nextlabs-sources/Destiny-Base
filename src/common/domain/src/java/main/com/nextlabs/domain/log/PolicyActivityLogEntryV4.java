 ...
 *
 * @author amorgan
 * @version $Id: //depot/Destiny/D_Nimbus/release/8.1.2/main/src/common/domain/src/java/main/com/nextlabs/domain/log/PolicyActivityLogEntryV4.java#1 $:
 */
...
public final class PolicyActivityLogEntryV4 extends BaseLogEntry implements Externalizable, PolicyActivityLogEntryWrapper {
    private long policyId;
    private PolicyActivityInfoV4 info;
    private Collection<IPair<String, String>> tags = new ArrayList<IPair<String, String>>();

    /**
     * Default constructor for Hibernate
     */
    public PolicyActivityLogEntryV4() {
    }

    public PolicyActivityLogEntryV4(final PolicyActivityInfoV4 info, final long policyId, final Collection<IPair<String, String>> tags, final long uid) {
        super(uid, info.ts);
        this.info = info;
    ...
    public PolicyActivityLogEntryV4(final PolicyActivityInfoV4 info, final long policyId, final long uid) {
        super(uid, info.ts);
        this.info = info;
        this.policyId = policyId;
    }

    public PolicyActivityLogEntryV4(final PolicyActivityInfoV4 info, final long policyId) {
        super();
    ...
    public boolean equals(final Object obj) {
        ...
        if (!(obj instanceof PolicyActivityLogEntryV4)) {
            return false;
        }
        if (this == obj) {
            return true;
        }
        final PolicyActivityLogEntryV4 entry = (PolicyActivityLogEntryV4) obj;
    ...
    public String toString() {
        final StringBuffer rv = new StringBuffer("PolicyActivityLogEntryV4[");
