...
/**
 * @author rlin
 * @version $Id: //depot/Destiny/D_Nimbus/release/8.1.2/main/src/common/domain/src/java/main/com/nextlabs/domain/enrollment/ContactReservedFieldEnumType.java#1 $
 */
