 ...
 *
 * @version $Id: //depot/Destiny/D_Nimbus/release/8.1.2/main/src/common/pf/src/java/main/com/bluejungle/pf/destiny/lib/ClientInformationDTO.java#1 $
 */
...
public class ClientInformationDTO implements Externalizable, Serializable, Cloneable {
    // Allatori obfuscation can change this and the actual value right now is different,
    // but for backwards compabilitiy we should use the "old" value
    static final long serialVersionUID = -2387695993664100124L;
