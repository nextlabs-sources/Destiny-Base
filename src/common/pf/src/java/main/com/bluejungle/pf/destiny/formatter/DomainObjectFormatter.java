 ...
 *
 * @version $Id: //depot/Destiny/D_Nimbus/release/8.1.2/main/src/common/pf/src/java/main/com/bluejungle/pf/destiny/formatter/DomainObjectFormatter.java#1 $
 */
    ...
    private class PredicateVisitor implements IPredicateVisitor {
        ...
        public void visit(ICompositePredicate pred, String opStr, boolean preorder ) {
            if ( preorder ) {
                ...
                if ( pred.predicateCount() == 1 && BooleanOp.NOT.getName().equals(opStr)) {
                    put( opStr, " (" );
                } else {
                    put("(");
                }
