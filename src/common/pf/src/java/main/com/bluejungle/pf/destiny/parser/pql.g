...
expression
    ...
    |   quoted_string
    |   numeric_literal
    |   !smv:string_multi_value_literal {
        #expression = #([STRING_MULTIVALUE_LITERAL], smv);
    }
    |   !nmv:numeric_multi_value_literal {
        #expression = #([NUMERIC_MULTIVALUE_LITERAL], nmv);
    }
    |   idnumber
    |   NULL
    ;
...
relation_op
    ...
    |   op13:GT {
        #op13.setType(RELATION_OP);
    }
    |   op14:GT_CI {
        #op14.setType(RELATION_OP);
    }
    |   op15:GTE {
        #op15.setType(RELATION_OP);
    }
    |   op16:GTE_CI {
        #op16.setType(RELATION_OP);
    }
    |   op17:LT {
        #op17.setType(RELATION_OP);
    }
    |   op18:LT_CI {
        #op18.setType(RELATION_OP);
    }
    |   op19:LTE {
        #op19.setType(RELATION_OP);
    }
    |   op20:LTE_CI {
        #op20.setType(RELATION_OP);
    }
    |   op21:EQ {
        #op21.setType(RELATION_OP);
    }
    |   op22:EQ_CI {
        #op22.setType(RELATION_OP);
    }
    |   op23:NEQ {
        #op23.setType(RELATION_OP);
    }
    |   op24:NEQ_CI {
        #op24.setType(RELATION_OP);
    }
    |   op25:WITHIN_LAST {
        #op25.setType(RELATION_OP);
    }
    |   RELATION_OP
    ;
...
string_multi_value_literal
    : LBRACKET! quoted_string (COMMA! quoted_string)* RBRACKET!
    ;

numeric_multi_value_literal
    : LBRACKET! numeric_literal (COMMA! numeric_literal)* RBRACKET!
    ;
