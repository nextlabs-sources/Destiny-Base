...
public abstract class EntityType extends EnumBase {
    ...
    /**
     * This is the only non-PQL entity in the system. Currently there
     * is no way to request "all PQL entities", nor is it clear if
     * we'll need it
     */
    public static final EntityType XACML_POLICY = new EntityType( "XACML POLICY", SpecType.ILLEGAL ) {
    	private static final long serialVersionUID = 1L;
        @Override
		public String emptyPql( String name ) {
            throw new UnsupportedOperationException("XACML_POLICY entity types don't use PQL");
        }
        @Override
        public boolean isPqlEntity() {
            return false;
        }
    };
    ...
    /**
     * Not all entities respresent their data as PQL
     */
    public boolean isPqlEntity() {
        return true;
    }
