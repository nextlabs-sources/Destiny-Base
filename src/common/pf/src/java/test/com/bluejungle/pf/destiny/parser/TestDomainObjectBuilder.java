...
public class TestDomainObjectBuilder extends TestCase {
    ...
    public void testDateCondition() throws Exception  {
        ...
        assertSame("type of rhs should be partial_date_time", ValueType.PARTIAL_DATE_TIME, val.getType());
        Object actVal = val.getValue();
        assertNotNull("value of rhs EvalValue should not be null", actVal);
        assertTrue("type of rhs EvalValue should be PartialDateTime", actVal instanceof PartialDateTime);
        assertEquals("value of rhs EvalValue should be 28", 28, ((PartialDateTime)actVal).getValue());
        assertNull("zone of rhs EvalValue should be null", ((PartialDateTime)actVal).getZoneId());
        assertEquals("type of rhs EvalValue should be DAY_IN_MONTH", PartialDateTime.DateType.DAY_IN_MONTH, ((PartialDateTime)actVal).getDateType());
    }

    public void testCurrentTimeCondition() throws Exception  {
        DateFormat format = new SimpleDateFormat("MMM d, yyyy hh:mm:ss aaa", Locale.US);
        ...
        IEvalValue val = c.getValue();
        assertNotNull("rhs value should not be null", val);
        assertSame("type of rhs should be ZONED_DATE", ValueType.ZONED_DATE_TIME, val.getType());
        Object actVal = val.getValue();
        assertNotNull("value of rhs EvalValue should not be null", actVal);
        assertTrue("type of rhs EvalValue should be Long", actVal instanceof ZonedDateTime);
    }
    ...
    public void testWeekdayStringCondition() throws Exception  {
        ...
        Object actVal = val.getValue();
        assertNotNull("value of rhs EvalValue should not be null", actVal);
        assertTrue("type of rhs EvalValue should be Long", actVal instanceof PartialDateTime);
        assertEquals("value of rhs EvalValue should be WEDNESDAY", DayOfWeek.WEDNESDAY.getValue(), ((PartialDateTime)actVal).getValue());
        assertNull("zone of rhs EvalValue should be null", ((PartialDateTime)actVal).getZoneId());
        assertEquals("type of rhs EvalValue should be DAY_OF_WEEK", PartialDateTime.DateType.DAY_OF_WEEK, ((PartialDateTime)actVal).getDateType());
    }
    ...
    public void testWeekdayLongCondition() throws Exception  {
        ...
        assertNotNull("value of rhs EvalValue should not be null", actVal);
        assertTrue("type of rhs EvalValue should be PartialDateTime", actVal instanceof PartialDateTime);
        assertEquals("value of rhs EvalValue should be 4", 4, ((PartialDateTime)actVal).getValue());
        assertNull("zone of rhs EvalValue should be null", ((PartialDateTime)actVal).getZoneId());
        assertEquals("type of rhs EvalValue should be DAY_OF_WEEK", PartialDateTime.DateType.DAY_OF_WEEK, ((PartialDateTime)actVal).getDateType());
    }
    ...
    public void testTimeCondition() throws Exception {
        ...
        assertNotNull("value of rhs EvalValue should not be null", actVal);
        assertTrue("type of rhs EvalValue should be PartialDateTime", actVal instanceof PartialDateTime);
        assertEquals("value of rhs EvalValue should be " + timeL, timeL, ((PartialDateTime)actVal).getValue());
        assertNull("zone of rhs EvalValue should be null", ((PartialDateTime)actVal).getZoneId());
        assertEquals("type of rhs EvalValue should be TIME_OF_DAY", PartialDateTime.DateType.TIME_OF_DAY, ((PartialDateTime)actVal).getDateType());
    }
    ...
    public void testDOWIMCondition() throws Exception  {
        ...
        assertNotNull("value of rhs EvalValue should not be null", actVal);
        assertTrue("type of rhs EvalValue should be PartialDateTime", actVal instanceof PartialDateTime);
        assertEquals("value of rhs EvalValue should be 3", 3, ((PartialDateTime)actVal).getValue());
        assertNull("zone of rhs EvalValue should be null", ((PartialDateTime)actVal).getZoneId());
        assertEquals("type of rhs EvalValue should be DAY_OF_WEEK_IN_MONTH", PartialDateTime.DateType.DAY_OF_WEEK_IN_MONTH, ((PartialDateTime)actVal).getDateType());
    }
    ...
    public void testYearCondition() throws Exception  {
        ...
        assertNotNull("value of rhs EvalValue should not be null", actVal);
        assertTrue("type of rhs EvalValue should be PartialDateTime", actVal instanceof PartialDateTime);
        assertEquals("value of rhs EvalValue should be 1945", 1945, ((PartialDateTime)actVal).getValue());
        assertNull("zone of rhs EvalValue should be null", ((PartialDateTime)actVal).getZoneId());
        assertEquals("type of rhs EvalValue should be YEAR", PartialDateTime.DateType.YEAR, ((PartialDateTime)actVal).getDateType());
    }
    ...
    public void testMultivalueLiterals() throws Exception {
        DomainObjectBuilder dob = new DomainObjectBuilder(
            "policy multivalue_literal_policy\n" +
            "  description \"multivalue literals rule!\"\n" +
            "  DO ALLOW\n" +
            "  FOR * ON *\n" +
            "  BY user.mv1 = [1, 2, 3, 8675309] OR user.mv2 = [\"a\", \"b\"]\n" +
            "  ON DENY DO LOG\n" +
            "  ON ALLOW DO LOG\n");
        ...
        assertNotNull("Parser returned a null policy", p);
        ITarget t = p.getTarget();
        // The only interesting thing is the subject
        IPredicate s = t.getSubjectPred();
        assertTrue ("Subject attributes must be OR-ed together", s instanceof ICompositePredicate);
        ICompositePredicate cs = (ICompositePredicate)s;
        IPredicate[] preds = (IPredicate[]) cs.predicates().toArray(new IPredicate[cs.predicateCount()]);
        assertEquals(preds.length, 2);

        final boolean[] foundMultivalueConstant = new boolean[preds.length];
        
        for (int i = 0; i < preds.length; i++) {
            foundMultivalueConstant[i] = false;
            
            final int finalI = i;
            
            cs.predicateAt(i).accept( new DefaultPredicateVisitor() {
                @Override
                public void visit(IRelation rel) {
                    IExpression rhs = rel.getRHS();
                    if (rhs instanceof Constant) {
                        IEvalValue v = ((Constant)rhs).getValue();
                        if (v.getType() == ValueType.MULTIVAL) {
                            foundMultivalueConstant[finalI] = true;
                        }
                    }
                }
            }, IPredicateVisitor.PREORDER );
        ...
        for (int i = 0; i < preds.length; i++) {
            assertTrue("The expression should be a multi-value constant", foundMultivalueConstant[i]);
        }
    }
}
