...
/**
 * @author sgoldstein
 * @version $Id: //depot/Destiny/D_Nimbus/release/8.1.2/main/src/common/pf/src/java/test/com/bluejungle/pf/CommonPFTestSuite.java#1 $
 */
...
public class CommonPFTestSuite {
    ...
    public static Test suite() {
        ...
        // No one uses this feature and the tests don't work anyway
        // suite.addTest(TestDACDomainObjectFormatter.suite());
        
        // No longer contains any tests
