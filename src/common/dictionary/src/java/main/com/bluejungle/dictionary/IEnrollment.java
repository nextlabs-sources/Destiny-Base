...
public interface IEnrollment {
    ...
    /**
     * Gets the description of this enrollment
     */
    String getDescription();

    /**
     * Sets the description of this enrollment
     */
    void setDescription(String description);
    
    /**
     * Get id of user who created this enrollment
     */
    Long getCreatedBy();

    /**
     * Set id of user who created this enrollment
     */
    void setCreatedBy(Long createdBy);

    /**
     * Get id of last user to update this enrollment
     */
    Long getLastUpdatedBy();

    /**
     * Set id of last user to update this enrollment
     */
    void setLastUpdatedBy(Long lastUpdatedBy);

    /**
     * Get date of enrollment creation
     */
    Date getCreatedDate();

    /**
     * Set date of enrollment creation
     */
    ...
    *
    ...
    /**
     * Get the isSyncing property of Enrollment
     * @return boolean true if currently syncing, or false if it is not
     */ 
    boolean getIsSyncing();
        
    /**
     * Set the isSyncing property of Enrollment
     * @param isSyncing the boolean value whether the enrollment is currently syncing
     */ 
    void setIsSyncing(boolean isSyncing);
    
    /**
     * Get the update record associated with the current enrollment
     * @return the update record
     */
    IUpdateRecord getUpdateRecord() throws DictionaryException;

    /**
     * Specify the next sync time. The caller is responsible for ensuring that this time
     * is in the future.
     *
     * @param nextSyncTime the time for the next scheduled sync
     */
    void setNextSyncTime(Calendar nextSyncTime);

    /**
     * Get the time of the next scheduled sync operation
     *
    ...
    /**
     * Get all <code>IEnrollmentDeltaCookie</code> associated with this enrollment
     *
     * TODO - should this be done in EnrollmentSession instead?
     */
    List<IEnrollmentDeltaCookie> getDeltaCookies() throws DictionaryException;

    /**
     * Get the <code>IEnrollmentDeltaCookide</code> for a particular type
     *
     * @param type the cookie type
     * @return the cookie
     */
    IEnrollmentDeltaCookie getDeltaCookieByType(String type) throws DictionaryException;

    /**
     * Set the <code>IEnrollmentDeltaCookie</code> associated with this enrollment
     */
    void setDeltaCookie(IEnrollmentDeltaCookie cookie) throws DictionaryException;
    
    /**
     * Delete all <code>IEnrollmentDeltaCookie</code> associated with this enrollment
     */
    void deleteDeltaCookies() throws DictionaryException;

    /**
     * Update isSyncing status of an enrollment.
     *
     * @param isSyncing Status of isSyncing
     * @throws DictionaryException if an error occurred
     */
    void updateIsSyncing(boolean isSyncing) throws DictionaryException;
