 ...
 * 
 * @author sgoldstein
 * @version $Id: //depot/Destiny/D_Nimbus/release/8.1.2/main/src/client/agent/controlmanager/com/bluejungle/destiny/agent/controlmanager/IAgentKeyManagerComponentBuilder.java#1 $
 */
...
public interface IAgentKeyManagerComponentBuilder {
    ...
    public static final String SECRET_TRUSTSTORE_NAME = "secretTruststore";
    ...
    /**
     * Set the registered keystore password
     * 
     * @param password
     * @throws IOException 
     */
    ...
    /**
     * Set the registered truststore password
     * 
     * @param password
     * @throws IOException 
     */
    ...
    /**
     * Update the registered key/trust passwords
     */
