...
/**
 * @author fuad
 * @version $Id: //depot/Destiny/D_Nimbus/release/8.1.2/main/src/client/agent/controlmanager/com/bluejungle/destiny/agent/activityjournal/IActivityJournal.java#1 $:
 */
...
public interface IActivityJournal extends IStartable, IInitializable {
    ...
    /**
     * determine if the ActivityJournal is enabled
     */
    public boolean isEnabled();
    
    /**
     * This will return the logIdGenerator (assuming the activity journal isEnabled())
     *
     * @return log id generator
