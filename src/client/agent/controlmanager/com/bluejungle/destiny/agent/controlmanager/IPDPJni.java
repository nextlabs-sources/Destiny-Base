...
public interface IPDPJni {
    ...
    /**
     * Sends a multi-query evaluation response back to PEP.
     *
    ...
    /**
     * Sends a permissions response back to PEP
     */
    public boolean SendPermissionsResponse(long handle, String reqId, Object[] responses);
}
