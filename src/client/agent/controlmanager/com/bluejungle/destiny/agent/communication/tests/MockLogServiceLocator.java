...
/**
 * @author fuad
 * @version $Id: //depot/Destiny/D_Nimbus/release/8.1.2/main/src/client/agent/controlmanager/com/bluejungle/destiny/agent/communication/tests/MockLogServiceLocator.java#1 $:
 */
