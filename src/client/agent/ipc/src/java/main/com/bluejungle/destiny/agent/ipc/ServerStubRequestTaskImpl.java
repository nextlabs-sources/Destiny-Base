 ...
 * 
 * @author ihanen
 * @version $Id: //depot/Destiny/D_Nimbus/release/8.1.2/main/src/client/agent/ipc/src/java/main/com/bluejungle/destiny/agent/ipc/ServerStubRequestTaskImpl.java#1 $
 */
