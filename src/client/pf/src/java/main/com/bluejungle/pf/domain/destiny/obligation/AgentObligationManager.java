...
public class AgentObligationManager extends DObligationManager implements ILogEnabled, IManagerEnabled, IInitializable {
    ...
    public static final ComponentInfo<AgentObligationManager> COMP_INFO = new ComponentInfo<AgentObligationManager>(IDObligationManager.CLASSNAME, CLASSNAME, IDObligationManager.CLASSNAME, LifestyleType.SINGLETON_TYPE);
