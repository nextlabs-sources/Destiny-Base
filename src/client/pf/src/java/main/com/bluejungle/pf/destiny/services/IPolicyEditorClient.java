...
public interface IPolicyEditorClient extends IConfigurable{
     ...
     * 
     * @param searchSpec
     * @return a list of leaf objects matching the search spec
     * @throws PolicyEditorException
     *             when the operation cannot complete.
     */
    ...
    /**
     * Similar to runLeafObjectQuery, but returns number of matching objects
     * Search Specification
     * 
     * @param searchSpec
     * @return the number of leaf objects matching the search spec
     * @throws PolicyEditorException
     *             when the operation cannot complete.
     */
    int countLeafObjectQuery(LeafObjectSearchSpec searchSpec) throws PolicyEditorException;
    ...
    void login() throws LoginException, AxisFault, PolicyEditorException;

    void updateDictionaryConsistentTime() throws PolicyEditorException;
}
