...
public class BundleVaultImplTest extends TestCase {
    ...
    private static final String RELATIVE_CLIENT_SECRET_KEYSTORE_FILE_NAME = "/run/server/certificates/agent-secret-keystore.p12";

    private static final String RELATIVE_SERVER_KEYSTORE_FILE_NAME = "/run/server/certificates/dcc-keystore.p12";
    private static final String RELATIVE_SERVER_TRUSTSTORE_FILE_NAME = "/run/server/certificates/dcc-truststore.p12";
    private static final String RELATIVE_SERVER_SECRET_KEYSTORE_FILE_NAME = "/run/server/certificates/dcc-secret-keystore.p12";
    ...
    protected void setUp() throws Exception {
        ...
        keyStoreFileInfo.add(new KeyManagerImpl.KeystoreFileInfo("keystore", baseDir + RELATIVE_CLIENT_KEYSTORE_FILE_NAME, "pkcs12", "password"));
        keyStoreFileInfo.add(new KeyManagerImpl.KeystoreFileInfo("truststore", baseDir + RELATIVE_CLIENT_TRUSTSTORE_FILE_NAME, "pkcs12", "password"));
        keyStoreFileInfo.add(new KeyManagerImpl.KeystoreFileInfo("secretKeystore", baseDir + RELATIVE_CLIENT_SECRET_KEYSTORE_FILE_NAME, "pkcs12", "password"));
        ...
        keyStoreFileInfo.add(new KeyManagerImpl.KeystoreFileInfo("privateKeyStore", baseDir + RELATIVE_SERVER_KEYSTORE_FILE_NAME, "pkcs12", "password"));
        keyStoreFileInfo.add(new KeyManagerImpl.KeystoreFileInfo("publicTrustStore", baseDir + RELATIVE_SERVER_TRUSTSTORE_FILE_NAME, "pkcs12", "password"));
        keyStoreFileInfo.add(new KeyManagerImpl.KeystoreFileInfo("secretKeystore", baseDir + RELATIVE_SERVER_SECRET_KEYSTORE_FILE_NAME, "pkcs12", "password"));
        keyManagerConfiguration.setProperty(KeyManagerImpl.KEYSTORE_FILE_INFO_PROPERTY_NAME, keyStoreFileInfo);
