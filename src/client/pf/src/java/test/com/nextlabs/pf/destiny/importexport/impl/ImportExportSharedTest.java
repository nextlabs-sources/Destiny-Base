...
public class ImportExportSharedTest  extends TestCase {
	...
	protected ImportExportSharedTest() throws AxisFault, LoginException, PolicyEditorException {
	...
	protected IPolicyEditorClient createLoggedInClient() throws AxisFault, LoginException, PolicyEditorException {
