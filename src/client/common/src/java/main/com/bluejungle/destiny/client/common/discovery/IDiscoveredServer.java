 ...
 * 
 * @author ihanen
 * @version $Id: //depot/Destiny/D_Nimbus/release/8.1.2/main/src/client/common/src/java/main/com/bluejungle/destiny/client/common/discovery/IDiscoveredServer.java#1 $
 */
