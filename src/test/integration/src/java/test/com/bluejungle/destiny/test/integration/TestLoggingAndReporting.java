...
public class TestLoggingAndReporting extends BaseDACComponentTestCase {
    ...
    protected ComponentLookupIF getComponentLookup() {
        ...
        try {
            ...
            JSSESocketFactoryWrapper.attachToStub(lookup);
        } catch (IOException | AxisFault e1) {
            fail("No exception should be thrown when creating report component lookup service : " + e1.getLocalizedMessage());
        }
        return lookup;
    }
    ...
    protected ReportExecutionIF getReportExecution() {
        ...
        try {
            ...
            JSSESocketFactoryWrapper.attachToStub(execution);
        } catch (IOException | AxisFault e1) {
    ...
    protected ReportLibraryIF getReportLibrary() {
        ...
        try {
            ...
            JSSESocketFactoryWrapper.attachToStub(library);
        } catch (IOException | AxisFault e1) {
    ...
    public static class TestRemoteLoginMgr extends RemoteLoginManager {
        ...
        protected SecureSessionServiceIF getSecureSessionService(String serviceLocation) throws ServiceException, RemoteException {
            ...
            try {
                ...
                JSSESocketFactoryWrapper.attachToStub(serviceToReturn);
            } catch (IOException e) {
                fail("Unable to attach socket factory to stub", e);
            } catch (MalformedURLException e) {
                // Should never happen
